        ...
        <Container className='main'>
            <Row>
                <Col xs='12'>
                    ...
                    <dl>
                        <dt>Can use state</dt>
                        <dd>With the 'useState' hook, funtional components can now both render a display to the page and update the information to be shown.</dd>
...
//fat arrow function component taks 3 fewer lines. Common in React.
...
<div>
    ...
    <img width='100%' height='280px' src='https://i.ytimg.com/vi/_pfXEv9cFGE/maxresdefault.jpg' alt='card cap' />
        <CardBody>
            ...
            <CardSubtitle>A JS Library</CardSubtitle>
            <CardText><pre>const HelloWorld = () fatarrow </pre></CardText>
            <Button>Go Here</Button>
        </CardBody>
    </Card>
</div>